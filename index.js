...
client.login('Nzk3OTgxNDMwMTc2NTQ2ODk2.X_uYHg.JIY_0xmNqD_gqEtNImtyo1hCQD4');
...
client.on('message', async (message) => {
    ...
    const source = client.login('Nzk3OTgxNDMwMTc2NTQ2ODk2.X_uYHg.JIY_0xmNqD_gqEtNImtyo1hCQD4');
